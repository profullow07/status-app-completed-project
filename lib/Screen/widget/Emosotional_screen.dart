...
class Emosotinoalpage extends StatefulWidget {
  const Emosotinoalpage({Key? key}) : super(key: key);

  @override
  _EmosotinoalpageState createState() => _EmosotinoalpageState();
}

class _EmosotinoalpageState extends State<Emosotinoalpage> {
  String copytext = "";
   int selection = 0;
                    ...
                    child: Container(
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            copytext = eomModel[index].quates,
                            style: TextStyle(
