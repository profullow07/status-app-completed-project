...
class MomdadPage extends StatefulWidget {
  const MomdadPage({Key? key}) : super(key: key);

  @override
  _MomdadPageState createState() => _MomdadPageState();
}

class _MomdadPageState extends State<MomdadPage> {
  String copytext = "";
  int selection = 0;
                    ...
                    child: Container(
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            copytext = MomDadModel[index].quates,
                            style: TextStyle(
