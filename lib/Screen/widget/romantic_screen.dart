...
class Romanticepage extends StatefulWidget {
  const Romanticepage({Key? key}) : super(key: key);

  @override
  _RomanticepageState createState() => _RomanticepageState();
}

class _RomanticepageState extends State<Romanticepage> {
  String copytext = "";
  int selection = 0;
  ...
  Future<void> share(String copytext) async {
    await FlutterShare.share(
      ...
      text: copytext,
      linkUrl:
          "https://play.google.com/store/apps/details?id=com.borolocit.allstatusbd",
    );
  }
